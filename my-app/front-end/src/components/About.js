        ...
        <div className='about' id='about'>
            <div className='about__content'>
                ...
                <div className='about__description'>
                    Here you will find more information about me, how I got into programming, and
                    my current skills.
                </div>
                <div className='about__container'>
                    <div className='text__primary-about'>
                        ...
                        <p className='text__space'> 
                          ...
                          I ventured into tech during high school by teaching myself how to use FL Studio. 
                          Despite getting into IUPUI's music technology program, I eventually decided to leave, seeking a new direction. 
                        </p>
                        <p className='text__space'> 
                          During a break, I delved into PC gaming and hardware, sparking a new interest. I wanted to learn how video games were made and that's what lead me to programming.
                          ...
                          During the bootcamp I started to lean towards frontend development and UI/UX design. 
